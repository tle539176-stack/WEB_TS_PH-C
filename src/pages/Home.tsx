        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center mb-12">
            <div className="flex items-center justify-center gap-3 mb-6">
              <Badge className="bg-[#0A3151] text-white border-none px-3 py-1 text-xs uppercase tracking-widest font-semibold">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Link to="/books">
                <Button className="bg-[#0A3151] hover:bg-[#1A252F] text-white px-8 py-6 text-lg group shadow-sm transition-all">
                  Khám phá Tủ sách
                  <ArrowRight className="ml-2 w-5 h-5 group-hover:translate-x-1 transition-transform" />
                </Button>
              </Link>
              <Link to="/notes">
                <Button variant="outline" className="px-8 py-6 text-lg border-neutral-300 hover:bg-neutral-50 text-[#0A3151] font-medium">
                  Đọc Ghi chú Y khoa
                </Button>
              </Link>
            </div>
          ...
          <motion.div
            ...
            className="relative w-full aspect-[16/9] md:aspect-[21/9] overflow-hidden shadow-xl border border-neutral-200/50"
          >
            <img
              src={heroImage}
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card className="border border-neutral-100 shadow-sm bg-white hover:shadow-md transition-all group">
              <CardContent className="p-8">
                <HeartPulse className="w-10 h-10 text-[#0A3151] mb-6 group-hover:scale-110 transition-transform" />
            ...
            <Card className="border border-neutral-100 shadow-sm bg-white hover:shadow-md transition-all group">
              <CardContent className="p-8">
                <Sparkles className="w-10 h-10 text-[#0A3151] mb-6 group-hover:scale-110 transition-transform" />
            ...
            <Card className="border border-neutral-100 shadow-sm bg-white hover:shadow-md transition-all group">
              <CardContent className="p-8">
                <Activity className="w-10 h-10 text-[#0A3151] mb-6 group-hover:scale-110 transition-transform" />
          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div className="order-2 lg:order-1">
                <Badge className="bg-white/10 text-white hover:bg-white/20 border-none mb-6 px-3 py-1.5 uppercase tracking-widest text-xs">
                  Ấn phẩm mới nhất
                </Badge>
                ...
                <div className="flex items-center gap-6">
                  <Link to={`/books/${featuredBook.slug}`}>
                    <Button className="bg-white text-[#0A3151] hover:bg-neutral-100 px-8 py-6 text-lg font-bold">
                      Đọc thử ngay
                    </Button>
                  </Link>
                  <div className="flex items-center gap-2">
                    <div className="flex -space-x-2">
                      {[1,2,3].map(i => (
                        <div key={i} className="w-10 h-10 border-2 border-[#0A3151] overflow-hidden">
              ...
              <div className="order-1 lg:order-2 flex justify-center">
                <div className="relative group perspective-1000">
                  <motion.div
                    ...
                    className="relative z-10 w-full max-w-sm shadow-2xl overflow-hidden border-l-8 border-white/20"
                  >
              ...
              {recentNotes.map((note) => (
                <Link key={note.id} to={`/notes/${note.slug}`} className="group">
                  <article className="space-y-4">
                    <div className="aspect-[4/3] overflow-hidden bg-neutral-100 border border-neutral-200/60">
                    ...
                    <div>
                      ...
                      <h4 className="text-xl font-serif font-bold group-hover:text-[#0A3151] transition-colors line-clamp-2 mb-2">
                        {note.title}
                      </h4>
